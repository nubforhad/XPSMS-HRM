<div class="sidebar-wrapper" style="background:inherit; min-height:100vh; padding-bottom:20px;">
    ...
    <ul class="sidebar-menu list-unstyled mt-3" style="padding:0 10px !important; margin-top:15px !important;">
        ...
        <li><a href="{{ route('leave.index') }}" class="sidebar-link" style="display:flex !important; align-items:center !important; gap:10px !important; color:#d1d5db !important; text-decoration:none !important; padding:10px 14px !important; border-radius:8px !important; margin-bottom:4px !important; font-size:14.5px !important; transition:all 0.2s ease !important;" onmouseover="this.style.background='#4fd1c5'; this.style.color='#0f172a';" onmouseout="this.style.background='transparent'; this.style.color='#d1d5db';"><i class="bi bi-calendar-check" style="font-size:16px !important; width:18px !important; text-align:center !important;"></i><span>Leave</span></a></li>

        <li><a href="{{ route('payroll.index') }}" class="sidebar-link" style="display:flex !important; align-items:center !important; gap:10px !important; color:#d1d5db !important; text-decoration:none !important; padding:10px 14px !important; border-radius:8px !important; margin-bottom:4px !important; font-size:14.5px !important; transition:all 0.2s ease !important;" onmouseover="this.style.background='#4fd1c5'; this.style.color='#0f172a';" onmouseout="this.style.background='transparent'; this.style.color='#d1d5db';"><i class="bi bi-calendar-event" style="font-size:16px !important; width:18px !important; text-align:center !important;"></i><span>Payroll</span></a></li>
        <li><a href="{{ route('category.index') }}" class="sidebar-link" style="display:flex !important; align-items:center !important; gap:10px !important; color:#d1d5db !important; text-decoration:none !important; padding:10px 14px !important; border-radius:8px !important; margin-bottom:4px !important; font-size:14.5px !important; transition:all 0.2s ease !important;" onmouseover="this.style.background='#4fd1c5'; this.style.color='#0f172a';" onmouseout="this.style.background='transparent'; this.style.color='#d1d5db';"><i class="bi bi-calendar-event" style="font-size:16px !important; width:18px !important; text-align:center !important;"></i><span>Loan</span></a></li>
